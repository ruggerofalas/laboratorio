...
public class ServerStr {
  ...
  public Socket attendi() {
    try {
      ...
      // chiudo 1l server per inibire altri client
      server.close();
  ...
  System.out.println("3 benvenuto client, scrivi una frase e la trasfozmo in maiuscolo. Attendo ...");
  stringaRicevuta = inDalClient.readLine();
  System.out.println("6 ricevuta la stringa dal cliente : "+stringaRicevuta) ;
  //la modifico e la rispedisco al client stringaModificata=stringaRicevuta. toUpperCase() :
  System.out.println("7 invio la stringa modificata al client ...");
  outVersoClient.writeBytes (stringaModificata+'\n');
  //termina eraborazione sul server: chiudo la connessione del client
